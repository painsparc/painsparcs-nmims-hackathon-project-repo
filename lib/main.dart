      ...
      builder: (context, snapshot) {
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            // Extract keys carefully, supporting both new schema (V1/V2) and old schema (apiKey)
            final String apiKeyV1 = data['apiKeyV1'] ?? data['apiKey'] ?? 'No Key';
            final String apiKeyV2 = data['apiKeyV2'] ?? 'No V2 Key';
            ...
            return Card(
              ...
              child: ListTile(
                ...
                subtitle: Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          "Legacy: $apiKeyV1", // Displaying V1 key as primary ID
                ...
                onTap: () {
                  // Pass both keys to the new MigrationScreen constructor
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                ...
                trailing: Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    // COPY BUTTON (Copies V1 Key by default)
                    IconButton(
                      icon: const Icon(Icons.copy, size: 20, color: Colors.tealAccent),
                      tooltip: 'Copy API Key V1',
                      onPressed: () {
                        Clipboard.setData(ClipboardData(text: apiKeyV1));
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: const Text("API Key V1 Copied"),
